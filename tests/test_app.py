...
def test_duplicate_signup_returns_bad_request_without_mutating_state(client):
    # Arrange
    activity_name = "Chess Club"
...
def test_unregister_missing_participant_returns_not_found_without_mutating_state(client):
    # Arrange
    activity_name = "Chess Club"
